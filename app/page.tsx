...
export default function Home() {
  ...
  return (
    <main className={`bg-white ${lexend.className} overflow-hidden`}>
      ...
      <section
        ref={fadeBg}
        className="h-screen bg-[url(/images/amlaBg.png)] pointer-events-none overflow-hidden bg-center bg-no-repeat bg-cover text-white flex items-start lg:items-center justify-center pt-24 lg:pt-0"
      >
        <div className="h-screen w-screen bg-black/20 "></div>
        <h1 className="text-pretty text-8xl lg:text-[160px] leading-[1.5] lg:leading-none font-extrabold w-3/4 lg:w-1/6 absolute left-3 lg:left-80 top-20 lg:top-auto">
