    ...
    <main className={`bg-white ${lexend.className} overflow-hidden`}>
      ...
      <div id="pinContainer" className="h-screen w-full relative overflow-hidden bg-white">
        ...
        >
          ...
          <h1 className="text-balance text-[70px] md:text-8xl z-999 lg:text-[140px] leading-[1.1] font-extrabold w-[90%] md:max-w-5xl absolute left-4  md:left-20 lg:left-32 top-1/4 md:top-24 lg:top-28 z-10 tracking-tight">
        ...
        >
          <div id="ourStory" className="w-full max-w-[1400px] px-6 lg:px-14 flex flex-col md:flex-row sm:justify-center justify-end gap-80 items-end pb-40 mt-40 lg:mt-0 h-full relative z-10">
